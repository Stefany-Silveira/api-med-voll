...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver codigo http 400 quando dados de agendamento forem inválidos")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deveria devolver codigo http 200 quando dados de agendamento forem válidos")
    @WithMockUser
